...
if CLIENT then
	SWEP.PrintName = TEXT.UnarrestStick
	SWEP.Slot = 1
	SWEP.SlotPos = 3
	SWEP.DrawAmmo = false
...
SWEP.Instructions = TEXT.UnarrestStickInstructions
SWEP.Contact = ""
SWEP.Purpose = ""
...
function SWEP:PrimaryAttack()
	...
	CAKE.Response(trace.Entity, "You have been unarrested by " .. self.Owner:Nick() .. "!")
end
