...
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.Instructions	= TEXT.NukeDetInstructions
...
local PlantBomb = function(EntTable)
	...
	if not EntTable.Owner:Alive() then return end
...
function SWEP:PrimaryAttack()
	...
	timer.Simple(self.Primary.Delay + 0.2, function() self:PlantBomb() end)
...
function SWEP:SecondaryAttack()
	...
	self.Owner:PrintMessage(HUD_PRINTCENTER, TEXT.DetonationTime(self.DetTime))
