...
CAKE.AddVoice("combine", "vo/npc/male01/combine01.wav", 1, TEXT.YellCommand .. " Combine!", "vo/npc/female01/combine01.wav")
...
CAKE.AddVoice("gethellout", "vo/npc/male01/gethellout.wav", 1, TEXT.YellCommand .. " Get the hell out of here!", "vo/npc/female01/gethellout.wav")
...
CAKE.AddVoice("help", "vo/npc/male01/help01.wav", 1, TEXT.YellCommand .. " HELP!", "vo/npc/female01/help01.wav")
...
CAKE.AddVoice("letsgo", "vo/npc/male01/letsgo01.wav", 1, TEXT.YellCommand .. " Let's go!", "vo/npc/female01/letsgo01.wav")
CAKE.AddVoice("noscream1", "vo/npc/male01/no01.wav", 1, "No! NO!", "vo/npc/female01/no01.wav")
CAKE.AddVoice("noscream2", "vo/npc/male01/no02.wav", 1, TEXT.YellCommand .. " Noooooo!", "vo/npc/female01/no02.wav")
...
CAKE.AddVoice("overhere", "vo/npc/male01/overhere01.wav", 1, TEXT.YellCommand .. " Hey, over here!", "vo/npc/female01/overhere01.wav")
CAKE.AddVoice("runforyourlife", "vo/npc/male01/runforyourlife01.wav", 1, TEXT.YellCommand .. " Run for your life!", "vo/npc/female01/runforyourlife.wav")
...
CAKE.AddVoice("run", "vo/npc/male01/strider_run.wav", 1, TEXT.YellCommand .. " Ruuuuun!", "vo/npc/female01/strider_run.wav")
...
CAKE.AddVoice("chuckle", "npc/metropolice/vo/chuckle.wav", 2, TEXT.SlashMeCommand .. " chuckles")
...
CAKE.AddVoice("getdown", "npc/metropolice/vo/getdown.wav", 2, TEXT.YellCommand .. " Get down!")
CAKE.AddVoice("getoutofhere", "npc/metropolice/vo/getoutofhere.wav", 2, "Get out of here.")
CAKE.AddVoice("grenade", "npc/metropolice/vo/grenade.wav", 2, TEXT.YellCommand .. " Grenade!")
CAKE.AddVoice("help", "npc/metropolice/vo/help.wav", 2, TEXT.YellCommand .. " Help!")
CAKE.AddVoice("hesrunning", "npc/metropolice/vo/hesrunning.wav", 2, "/radio He's running!")
CAKE.AddVoice("holdit", "npc/metropolice/vo/holdit.wav", 2, TEXT.YellCommand .. " Hold it!")
...
CAKE.AddVoice("shit", "npc/metropolice/vo/shit.wav", 2, TEXT.YellCommand .. " Shit!")
CAKE.AddVoice("sweepingforsuspect", "npc/metropolice/vo/sweepingforsuspect.wav", 2, "/radio Sweeping for suspect.")
CAKE.AddVoice("thereheis", "npc/metropolice/vo/thereheis.wav", 2, TEXT.YellCommand .. " There he is!")
