...
CAKE.ConVars.Default_Roles = {} -- What roles can the character select when it is first made. ( This does not include public roles ) This cannot be changed with rp_admin setvar
