...
CAKE.ConVars.Default_Flags = {} -- What flags can the character select when it is first made. ( This does not include public flags ) This cannot be changed with rp_admin setvar
CAKE.ConVars.Default_Inventory = {} -- What inventory do characters start out with when they are first created. This cannot be changed with rp_admin setvar
