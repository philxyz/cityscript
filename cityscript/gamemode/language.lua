...
TEXT.ManageVehicleAddonsCommand = "/managevehicleaddons"
...
TEXT.AdminManageVehicleAddons = "Manage vehicle addons"
...
TEXT.HelpLong = {
	...
	"please check that they are set up for CityScript from within the Admin tab",
	"of the F1 menu.",
	"",
	"CREDITS:",
