...
TEXT.GiveMoneyUsedIncorrectly = "rp_givemoney used incorrectly. Try /give <amount> while looking at the player instead."
...
TEXT.ArrestMessage2 = function(name, time) return name .. " has been arrested for " .. time .. " seconds!" end
...
TEXT.NuclearScientist = "Nuclear Scientist"
...
TEXT.HellsAngelsGangLeader = "Hell's Angels Gang Leader"
TEXT.HellsAngelsGangMember = "Hell's Angels Gang Member"
TEXT.TheLegionGangLeader = "The Legion Gang Leader"
TEXT.TheLegionGangMember = "The Legion Gang Member"
TEXT.TheWIGangLeader = "The W.I. Gang Leader"
TEXT.TheWIGangMember = "The W.I. Gang Member"
...
TEXT.SetConVarInvalidArgumentCount = "Invalid number of arguments! ( rp_admin setvar \"varname\" \"value\" )"
...
TEXT.MePocketsABundleOfTokens = "/me stuffs some tokens into their pocket!"
