...
TEXT.HelpLong = {
	...
	"rp_admin quiet <name> [1|0]                     Stop a player using voice commands",
	...
	"",
	"rp_admin adddoor <groupid>                      Makes a door part of a numbered group which only",
	"                                                teams whose declaration lists that number, can open.",
	"",
